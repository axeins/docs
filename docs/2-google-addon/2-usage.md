...
1. After installation, go to **Extensions > AX1 > Data imports**. This opens a sidebar with which you can install and manage data imports.
...
The AX1 Add-on imports three types of accounting data, each with specific columns:
